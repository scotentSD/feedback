...
*To create the name of the file: type the name of the file in the rectangle above the edit area it should say feedback/_posts/ then the rectangle input box*
